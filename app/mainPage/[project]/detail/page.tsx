            ...
            <div className="relative w-full h-full bg-neutral-100 overflow-scroll snap-y">
              ...
              <div className="snap-center w-full h-[30%] grid grid-cols-7 items-center">
                ...
                {summary.map(({
                  ...
                  <UpdateTask  project_id={project_id} plan_id={"ABD"} reciever_id={reciever_id} sender_id={sender_id} comment={comment} progress={progress} files={files} chat_id={chat_id} createdAt={createdAt} />
                ))}
