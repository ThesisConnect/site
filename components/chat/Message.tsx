  ...
  if (isFile) {
    ...
    return (
      ...
      >
        {!isOwnMessage && (
          <Avatar
            src={userEachMessage?.avatar}
            alt={userEachMessage?.userName}
        ...
        >
          ...
          <div className="flex items-center my-2 space-x-2">
            ...
            <div
              ...
              onClick={() =>
                handleFilePreview(fileContent.link, fileContent.type_file)
              }
            >
              {fileContent.name}
            </div>
          ...
          {fileContent.size && (
            <p className="text-xs text-gray-500">{bytes(fileContent.size)}</p>
          )}
          {/* {fileContent.memo && (
