          ...
          <div className="flex flex-col py-3 px-5 gap-1">
            <div className="w-full flex justify-end">
              <div className="flex justify-center items-center gap-2">
                {task ? (
                  <div className="w-[75px] flex items-center justify-center rounded-full bg-[#B3D1D0] font-semibold text-teal-800 p-1 text-sm">
                    Gantt
                  </div>
                ) : (
                  <div className="w-[90px] flex items-center justify-center rounded-full bg-[#B3D1D0] font-semibold text-teal-800 p-1 text-sm">
                    Not gantt
                  </div>
                )}
              </div>
            ...
            <div className="flex">
              <div className="flex w-[50%] gap-2 items-center">
                <div className="grid grid-cols-4 items-center">
                  <div className="col-span-2 text-teal-800 font-semibold p-1">
                    Start date
                  </div>
