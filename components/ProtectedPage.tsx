...
const ProtectedPage: FC<ProtectedPageProps> = ({ children }) => {
  ...
  const [firstLoad,setFirstLoad] = userStore((state) => [state.firstLoad,state.setFirstLoad]);
  ...
  }, [isAuthenticated,router,setFirstLoad]);
  if (!isMounted) return null;
  if((isLoading || isAuthenticated===null)&&firstLoad) return (
